...
object WordCountJobRuntime {
  def main(args: Array[String]){
    ...
    conf.setAppName("Wow,WordCount") //设置应用程序的名称，在程序运行的监控界面可以看到名称
    ...
    /**
      ...
      */
    val lines = sc.textFile("data/wordcount/helloSpark.txt") //读取本地文件并设置为一个Partion
    ...
    /**
      ...
      */
    val wordCountsOdered = pairs.reduceByKey(_+_).saveAsTextFile("data/wordcount/wordCountResult.log")
